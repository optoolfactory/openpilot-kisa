...
from opendbc.car.hyundai.values import HyundaiFlags, CAR, DBC, Buttons, CarControllerParams, \
                                       LEGACY_SAFETY_MODE_CAR_ALT, ANGLE_CONTROL_CAR
...
class CarState(CarStateBase):
  ...
  def update_canfd(self, can_parsers) -> structs.CarState:
    ...
    if self.CP.carFingerprint in (CAR.HYUNDAI_KONA_EV_2ND_GEN, CAR.HYUNDAI_IONIQ_5_PE, CAR.KIA_EV9, CAR.HYUNDAI_SANTA_FE_2024_MX5, CAR.HYUNDAI_SANTA_FE_2024_HEV_MX5, CAR.GENESIS_GV80_2024):
