...
class CAR(StrEnum):
  ...
  GENESIS_EGV70_1ST_GEN = "GENESIS EGV70 1ST GEN"
...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.KIA_K8_GL3: HyundaiCarInfo("Kia K8 GL3 (with HDA II) 2023", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_k])),
...
CANFD_CAR = {CAR.KIA_EV6, CAR.IONIQ_5, CAR.IONIQ_6, CAR.TUCSON_4TH_GEN, CAR.SANTA_CRUZ_1ST_GEN, CAR.KIA_SPORTAGE_5TH_GEN, CAR.GENESIS_GV70_1ST_GEN,
             ...
             CAR.GENESIS_GV80, CAR.KIA_CARNIVAL_4TH_GEN, CAR.KIA_SORENTO_HEV_4TH_GEN, CAR.KONA_EV_2ND_GEN, CAR.KIA_K8_GL3, CAR.KIA_K8_HEV_1ST_GEN,
             CAR.STARIA_4TH_GEN, CAR.GENESIS_EGV70_1ST_GEN}
...
HYBRID_CAR = {CAR.IONIQ_PHEV, CAR.ELANTRA_HEV_2021, CAR.KIA_NIRO_PHEV, CAR.KIA_NIRO_HEV_2021, CAR.SONATA_HYBRID, CAR.KONA_HEV, CAR.IONIQ,
              ...
              CAR.KIA_K8_HEV_1ST_GEN, CAR.KIA_NIRO_HEV_2ND_GEN, CAR.KIA_SORENTO_HEV_4TH_GEN, CAR.K5_HEV_JF, CAR.K7_HEV_YG, CAR.GRANDEUR_HEV_IG, CAR.GRANDEUR_HEV_FL_IG, CAR.AVANTE_HEV_CN7,
              CAR.SONATA_HEV_LF}
EV_CAR = {CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_EV_2ND_GEN, CAR.KONA_EV_2022,
          ...
          CAR.NEXO_FE, CAR.SOUL_EV_SK3, CAR.GENESIS_EGV70_1ST_GEN}
...
LEGACY_SAFETY_MODE_CAR = {CAR.HYUNDAI_GENESIS, CAR.IONIQ_EV_LTD, CAR.KIA_OPTIMA_G4,
                          ...
                          CAR.IONIQ_PHEV, CAR.IONIQ, CAR.KONA_EV, CAR.IONIQ_EV_2020, CAR.KIA_SORENTO, CAR.SONATA_LF,
                          CAR.KIA_OPTIMA_G4_FL, CAR.K5_HEV_JF, CAR.GENESIS_DH}
...
DBC = {
  ...
  CAR.ELANTRA_GT_I30: dbc_dict('hyundai_kia_generic', RadarTrack),
  ...
  CAR.NEXO_FE: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar_generated'),
  ...
  CAR.KIA_K8_GL3: dbc_dict('hyundai_canfd', None),
  ...
  CAR.GENESIS_EGV70_1ST_GEN: dbc_dict('hyundai_canfd', None),
}
