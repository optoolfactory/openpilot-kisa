...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"KisaForceShutdown", PERSISTENT},
    {"KisaForceShutdownTrigger", PERSISTENT},
    {"KisaAutoScreenOff", PERSISTENT},
    {"KisaUIBrightness", PERSISTENT},
    {"KisaUIVolumeBoost", PERSISTENT},
    {"KisaEnableDriverMonitoring", PERSISTENT},
    {"KisaEnableLogger", PERSISTENT},
    {"KisaEnableGetoffAlert", PERSISTENT},
    ...
    {"KisaVariableSteerMax", PERSISTENT},
    {"KisaVariableSteerDelta", PERSISTENT},
    ...
    {"KISAServer", PERSISTENT},
    {"KISAServerAPI", PERSISTENT},
